...
export class SenhasService {
  ...
  somaGeral() {
    this.senhasGeral++; this.senhasTotal++; this.count3++
  }
  somaPrior() {
    this.senhasPrior++; this.senhasTotal++; this.count2++
  }
  somaExame() {
    this.senhasExame++; this.senhasTotal++; this.count1++
  }
  ...
  public contadorSenhasNaoAtendidas: number = 0;

  senhasNaoChamadas() {
    this.contadorSenhasNaoAtendidas++
    this.senhas.shift()
  }
  ...
  gerarRelatorioCompleto(senhasAtendidasENaoAtendidas: any[]): any[] {
    let relatorio: any[] = [];
